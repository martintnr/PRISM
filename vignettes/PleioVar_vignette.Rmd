...
If you do not, the Zscores will be computed with $tstat/\sqrt{(sample \: size)}$. If you formatted your data according to LHC-MR guidelines and the previous steps worked, everything should run automatically.
