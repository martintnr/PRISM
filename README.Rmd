...
On a single core, `PRISM_main` is expected to complete execution within approximately 25 minutes. Upon completion, the Results/ directory will contain, for each trait, a file that includes variants, p-values from PRISM, and pleiotropy annotations. 
